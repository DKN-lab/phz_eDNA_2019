...
ggplot(df_spec, aes(x = time, y = intensity, color = quencher_eq, group = quencher_eq)) + geom_path()
...
ggplot(df_spec_preds, aes(x = time, group = run, color = quencher_eq)) + geom_path(aes(y = pred)) + geom_point(aes(y = bg_sub),alpha = 0.2, shape = 21)
